...
def combine_results(result1, result2):
    ...
    combined["title_spans"].sort()  # changed a bit, since they could be unsorted
    combined["line_matches"] = [lines_by_no[line_no] for line_no in sorted(lines_by_no.keys())]
    return combined
